...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help='Output parquet file path (default: data/indices/nsd_index/subject=<subject>/index.parquet)'
    )
    parser.add_argument(
        '--max-sessions',
        type=int,
    ...
    if args.output is None:
        args.output = Path(f'data/indices/nsd_index/subject={args.subject}/index.parquet')
