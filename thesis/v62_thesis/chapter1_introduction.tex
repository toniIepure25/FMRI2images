...
\begin{itemize}
    ...
    \item a conservative qualitative analysis of retrieval-guided diffusion refinement using SD~2.1 img2img with CLIP-conditioned best-of-$N$ selection and uncertainty-aware strength, which exposes a low-level-versus-semantic trade-off rather than a uniform improvement over the retrieval anchor;
